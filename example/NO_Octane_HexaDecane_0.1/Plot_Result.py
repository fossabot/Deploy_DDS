...
'''
rel_error_lt_3 = final_comparision[final_comparision['Relative Error'] <= 0.05].shape[0]
...
rel_error_btn_15_18 = final_comparision[(final_comparision['Relative Error'] > 0.15) & (final_comparision['Relative Error'] <= 0.18)].shape[0]
rel_error_btn_18_21 = final_comparision[(final_comparision['Relative Error'] > 0.18) & (final_comparision['Relative Error'] <= 0.21)].shape[0]

# x = ['$<= 10\%$ ', '$ 10\% < x <= 20\%$','$ 20\% < x <= 30\%$','$ 30\% < x <= 40\%$','$ 40\% < x <= 50\%$','$ 50\% < x <= 60\%$','$ 60\% < x <= 70\%$','$ 70\% < x <= 80\%$','$ 80\% < x <= 90\%$','$ 90\% < x <= 100\%$','$ 100\% > x $']
x = ['$ 3$ ', '$ 6$','$ 9$','$ 12$','$ 15$','$ 18$','$ 21$']
y = [rel_error_lt_3,rel_error_btn_3_6,rel_error_btn_6_9,rel_error_btn_9_12, rel_error_btn_12_15,rel_error_btn_15_18,rel_error_btn_18_21]
plt.clf()
print(x,y)
fontsize = 19
