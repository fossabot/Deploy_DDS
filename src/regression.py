...
def regression_train_test(dataset,y,choice,curr_directory,level = 0,cluster_label=0,test_size_fraction=0.05,elimination=False,child_type='root',sl=0.05,process_type ='tree'):
        '''
