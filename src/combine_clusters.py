...
class combine_clusters():
	...
	def __init__(self,curr_directory,criteria,choice,process_type='optimized_cluster'):
		...
		self.ref_point = reference_point(self.curr_directory, self.criteria, self.choice)
	...
	def generate_regressor(self,nodes,data,cluster_label, node_index, choice='-o'):
		...
		print(str(self.curr_directory)+'/object_file/'+str(self.process_type)+'/regressor/regressor_'+str(cluster_label)+'.sav')
		#loading regressor
		regre = joblib.load(str(self.curr_directory)+'/object_file/'+str(self.process_type)+'/regressor/regressor_'+str(cluster_label)+'.sav')
