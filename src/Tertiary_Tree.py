...
class Ternary_Tree():
    ...
    def cluster_plot(self,data,data_left,data_center,data_right):
        ...
        plt.savefig(str(self.curr_directory)+'/plots/cluster_plot_y/cluster_y_com_'+str(self.cluster_label)+'.png')
        # plt.show()
        pass
    ...
    def R2(self,data):
        ...
        from DatasetTransfer import DatasetTransfer as DT
        ...
        # r2 = DT.processable_dataset(data)
        # print('r2: ', r2)
        return r2_simple
